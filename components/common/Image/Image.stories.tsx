...
Demo.args = {
  alt: 'Def Image',
  src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuyAXrnh_zYwlV7_xzCuNKofnPUhTfzEBtJQ&usqp=CAU',
  width: 0,
  height: 0,
  isWide: true
};
...
SpeakerPhoto.args = {
  alt: 'Speaker Photo',
  src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRln3_7OACCZ8SzJL-NSSlJz8dzl_I5JebwfA&usqp=CAU',
};
